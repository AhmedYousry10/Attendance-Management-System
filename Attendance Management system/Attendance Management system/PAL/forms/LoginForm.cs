...
namespace Attendence_Manngment_System.PAL.Forms
{
    public partial class LoginForm : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            List<user> Users = xmloperators.DeserializeXmlFileToList(@"C:\Users\Nasef\Desktop\Attendance-Management-System-AhmedMostafa\sampl01.xml");
            user validatedUser;
            if (ValidateLogin(out validatedUser))
            {
                ...
                {
                    FormTeacher teacherForm = new FormTeacher(Users[index].Name , Users[index].Rr.ToString());
